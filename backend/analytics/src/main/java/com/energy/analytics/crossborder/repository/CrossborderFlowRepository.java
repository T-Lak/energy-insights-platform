package com.energy.analytics.crossborder.repository;
...
public class CrossborderFlowRepository implements BatchRepository<FlowPoint> {
   ...
   public List<FlowGridEdgeDTO> getLatestFlowPoints(String region) {
      String sql = """
         SELECT
   ...
   public List<FlowGridEdgeDTO> getWeeklyFlows(Instant start, Instant end, String region) {
      return getFlowsFromView("view_crossborder_flows_hourly", start, end, region);
   }

   public List<FlowGridEdgeDTO> getMonthlyFlows(Instant start, Instant end, String region) {
      return getFlowsFromView("view_crossborder_flows_daily", start, end, region);
   }

   public List<FlowGridEdgeDTO> getFlowsFromView(String viewName, Instant start, Instant end, String region) {
